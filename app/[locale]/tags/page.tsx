...
export default async function Page({ params: { locale } }: TagsProps) {
  ...
  return (
    <>
      <div className=" flex min-h-screen flex-col items-center justify-center space-x-6 divide-y divide-gray-200 md:flex-row md:divide-y-0 dark:divide-gray-700">
