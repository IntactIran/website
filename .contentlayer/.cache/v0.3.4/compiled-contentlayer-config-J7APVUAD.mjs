...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      title: "Intact Iran",
      author: "Anonamous Authors",
      headerTitle: "Intact Iran",
      description: "To end all kinds of non-consenting child genital mutilation",
      language: "en",
      theme: "system",
      // system, dark or light
      siteUrl: "https://intactiran.vercel.app",
      // siteRepo: 'https://github.com/PxlSyl/tailwind-nextjs-starter-blog-i18n',
      siteLogo: "/static/images/logo.png",
      // socialBanner: '/static/images/twitter-card.png',
      // mastodon: 'https://mastodon.social/@mastodonuser',
      email: "InttactIran@gmail.com",
...
var require_locales = __commonJS({
  "app/[locale]/i18n/locales.js"(exports, module) {
    var fallbackLng2 = "fa";
    var secondLng = "en";
    module.exports = { fallbackLng: fallbackLng2, secondLng };
  }
});

// contentlayer.config.ts
var import_siteMetadata = __toESM(require_siteMetadata());
var langs = __toESM(require_locales());
...
var langsList = Object.entries(langs).map((item, index) => item[1]);
...
//# sourceMappingURL=compiled-contentlayer-config-J7APVUAD.mjs.map
